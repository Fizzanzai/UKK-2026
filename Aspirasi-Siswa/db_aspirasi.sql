...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Apr 2026 pada 21.05
...
(34, 1001, 2, '11111111111111', '11111111111111111', '2026-04-07 01:40:50');
...
--
ALTER TABLE `tb_aspirasi`
  MODIFY `id_aspirasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT untuk tabel `tb_input_aspirasi`
--
ALTER TABLE `tb_input_aspirasi`
  MODIFY `id_pelaporan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tb_aspirasi`
  ADD CONSTRAINT `fk_pelaporan` FOREIGN KEY (`id_pelaporan`) REFERENCES `tb_input_aspirasi` (`id_pelaporan`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_input_aspirasi`
--
ALTER TABLE `tb_input_aspirasi`
  ADD CONSTRAINT `fk_kategori` FOREIGN KEY (`id_kategori`) REFERENCES `tb_kategori` (`id_kategori`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_siswa` FOREIGN KEY (`nis`) REFERENCES `tb_siswa` (`nis`) ON UPDATE CASCADE;
COMMIT;
